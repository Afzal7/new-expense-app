          ...
          <div className="group relative m-auto max-w-5xl px-6">
            ...
            <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
              ...
              <div className="flex">
                <Image
                  className="mx-auto h-5 w-fit dark:invert"
                  src="https://html.tailus.io/blocks/customers/meta.svg"
                  alt="Meta Logo"
                  height={20}
                  width={60}
                />
              ...
              <div className="flex">
                <Image
                  className="mx-auto h-5 w-fit dark:invert"
                  src="https://html.tailus.io/blocks/customers/netflix.svg"
                  alt="Netflix Logo"
                  height={20}
                  width={80}
                />
              ...
              <div className="flex">
                <Image
                  className="mx-auto h-5 w-fit dark:invert"
                  src="https://html.tailus.io/blocks/customers/apple.svg"
                  alt="Apple Logo"
                  height={20}
                  width={50}
                />
