...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#121110] text-[#F2F0ED] font-sans selection:bg-[#FF8A65] selection:text-[#121110] overflow-x-hidden">
      ...
      <div className="fixed top-6 left-0 right-0 flex justify-center z-40 px-4">
        <nav
          ...
          ${scrolled ? "bg-[#1C1C1A]/80 backdrop-blur-xl border border-white/10 shadow-2xl" : "bg-[#1C1C1A] border border-white/5"}
        `}
        >
      ...
      <section className="relative pt-48 pb-24 md:pt-64 md:pb-40 px-6 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#FF8A65] opacity-[0.08] blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-zinc-400 max-w-2xl mx-auto mb-12 leading-snug">
            We built a
            <span className="text-white decoration-zinc-600 underline decoration-2 underline-offset-4 mx-2">
              dopamine-driven
            </span>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <button className="group relative px-8 py-4 bg-[#FF8A65] text-[#121110] rounded-full text-lg font-bold transition-transform hover:scale-105 active:scale-95 shadow-[0_0_40px_-10px_rgba(255,138,101,0.5)]">
        ...
        <div className="mt-24 relative h-[400px] max-w-4xl mx-auto hidden md:block">
          ...
          <div className="absolute left-10 top-10 w-72 bg-white text-black p-6 rounded-3xl shadow-2xl -rotate-6 transform hover:rotate-0 transition-transform duration-500 cursor-default z-10 border border-zinc-200">
          ...
          <div className="absolute right-10 top-20 w-80 bg-[#1C1C1A] border border-white/10 p-6 rounded-3xl shadow-2xl rotate-3 transform hover:rotate-0 transition-transform duration-500 z-20 backdrop-blur-md">
            ...
            <div className="bg-[#2C2C2A] rounded-xl p-3 flex items-center gap-3">
              <div className="text-2xl">✈️</div>
              <div className="text-sm text-zinc-300">Flight to Bangalore</div>
            </div>
          </div>
      ...
      <section id="vault" className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 md:flex items-end justify-between">
            ...
            <p className="md:max-w-sm text-zinc-400 mt-6 md:mt-0 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 bg-[#1C1C1A] rounded-[2.5rem] p-10 md:p-14 border border-white/5 relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-10 opacity-20 group-hover:opacity-100 transition-opacity duration-500">
                <LockIcon />
              </div>
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm font-bold mb-6 text-[#FF8A65]">
                ...
                <div className="mt-12 bg-[#121110] rounded-3xl p-6 border border-white/5 inline-flex items-center gap-6">
                  <div className="text-right">
                    <div className="text-xs font-bold text-zinc-500 uppercase tracking-widest">
                      Visibility
                    </div>
                    <div className="text-emerald-400 font-bold">Only You</div>
                  </div>
                  <div className="w-16 h-10 bg-[#2C2C2A] rounded-full p-1 relative cursor-pointer">
            ...
            {/* Feature 2: Tall Card */}
            <div className="bg-[#EBEBEB] text-[#121110] rounded-[2.5rem] p-10 border border-transparent relative overflow-hidden flex flex-col justify-between group">
              ...
              <div className="mt-10 bg-white rounded-2xl p-4 shadow-xl transform group-hover:-translate-y-2 transition-transform duration-300">
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-black text-white text-xs px-3 py-1.5 rounded-full font-bold">
                    Link
                  </button>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="bg-[#121110] rounded-[3rem] p-4 text-white shadow-[0_50px_100px_-20px_rgba(18,17,16,0.3)] transform rotate-2 hover:rotate-0 transition-transform duration-500">
                <div className="bg-[#1C1C1A] rounded-[2.5rem] h-[500px] p-6 relative overflow-hidden border border-white/10">
                  {/* Header */}
                  ...
                  <div className="space-y-3">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="flex items-center justify-between p-4 bg-[#2C2C2A] rounded-2xl active:scale-95 transition-transform cursor-pointer"
                      >
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 rounded-full bg-[#FF8A65] text-black flex items-center justify-center font-bold">
                            {i === 1 ? "🍔" : i === 2 ? "🚖" : "💻"}
                          </div>
                          <div>
                  ...
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-48 h-12 bg-white text-black rounded-full flex items-center justify-center font-bold shadow-xl cursor-pointer hover:scale-105 transition-transform">
                    <SparkleIcon />
      ...
      <footer className="py-24 px-6 border-t border-white/10">
        ...
        <div className="max-w-7xl mx-auto mt-24">
          <h1 className="text-[12vw] leading-none font-bold text-[#1C1C1A] select-none pointer-events-none text-center">
            FLOWSTATE
          </h1>
        </div>
      </footer>
