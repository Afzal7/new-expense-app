...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FDF8F5] via-[#FDF8F5] to-[#FFF5EE] text-[#121110] font-sans selection:bg-[#FF8A65] selection:text-white overflow-x-hidden">
      {/* Texture Overlay */}
      <div
      ...
      <div className="fixed top-0 left-0 right-0 flex justify-center z-50 px-4 pt-6">
        ...
        >
          ...
          >
            <div className="w-3 h-3 rounded-full bg-gradient-to-br from-[#FF8A65] to-[#FF6B45] shadow-lg shadow-orange-500/30" />
            <span className="bg-gradient-to-r from-[#121110] to-[#2a2a2a] bg-clip-text text-transparent">
              FlowState
            </span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-zinc-600">
            ...
            >
              Solutions
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] group-hover:w-full transition-all duration-300"></span>
            </a>
            <a
              href="#vault"
              className="hover:text-[#FF8A65] transition-all duration-300 relative group"
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button className="bg-gradient-to-r from-[#121110] to-[#2a2a2a] text-white px-5 py-2.5 rounded-full text-xs font-bold hover:scale-105 hover:shadow-xl transition-all duration-300 shadow-lg tracking-wide uppercase">
              Start Free
            </button>
          </div>
      ...
      >
        <div className="flex flex-col items-center gap-8 p-8">
          ...
          <div className="flex flex-col gap-4 mt-8 w-full max-w-xs">
            ...
            <button className="w-full bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] text-white px-6 py-3 rounded-full text-lg font-bold hover:scale-105 transition-transform shadow-lg">
              Start Free
            </button>
          </div>
        </div>
      ...
      <section className="relative pt-48 pb-32 px-6 overflow-hidden">
        ...
        <div
          className="absolute top-1/3 left-1/4 w-[600px] h-[600px] bg-gradient-to-br from-[#FF8A65]/10 to-transparent opacity-60 blur-[100px] rounded-full pointer-events-none animate-pulse"
          style={{ animationDuration: "8s" }}
        />
        <div
          className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-gradient-to-tl from-[#D0FC42]/10 to-transparent opacity-50 blur-[100px] rounded-full pointer-events-none animate-pulse"
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <div className="bg-white p-5 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-zinc-100/50 rotate-[-6deg] w-64 hover:rotate-0 hover:scale-105 hover:shadow-[0_25px_70px_-15px_rgba(0,0,0,0.4)] transition-all duration-500 backdrop-blur-xl">
              <div className="flex justify-between items-center mb-4">
                <div className="w-10 h-10 bg-gradient-to-br from-[#FFF0E0] to-[#FFE4CC] rounded-full flex items-center justify-center text-xl shadow-inner">
          ...
          >
            <div className="bg-gradient-to-br from-[#121110] to-[#1f1f1f] text-white p-5 rounded-[2rem] shadow-[0_25px_70px_-15px_rgba(0,0,0,0.5)] rotate-6 w-64 hover:rotate-0 hover:scale-105 hover:shadow-[0_30px_80px_-15px_rgba(0,0,0,0.6)] transition-all duration-500 border border-white/10">
              <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#D0FC42] to-[#b8e332] flex items-center justify-center shadow-lg shadow-lime-500/30">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              ...
              kill your{" "}
              <span className="font-serif italic text-transparent bg-clip-text bg-gradient-to-r from-[#FF8A65] via-[#FF6B45] to-[#FF8A65] animate-gradient">
                Flow.
              </span>
            </h1>
            ...
            >
              <button className="px-8 py-4 bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] text-white rounded-full text-lg font-bold hover:scale-105 hover:shadow-[0_20px_60px_-15px_rgba(255,138,101,0.7)] transition-all duration-300 shadow-[0_10px_40px_-15px_rgba(255,138,101,0.6)] flex items-center gap-2 group">
          ...
          <div className="bg-white rounded-[3rem] p-6 md:p-12 border border-zinc-200/50 shadow-[0_20px_70px_-15px_rgba(0,0,0,0.2)] max-w-5xl mx-auto relative overflow-hidden backdrop-blur-xl">
            ...
            <div className="flex justify-center mb-12 relative z-10">
              <div className="inline-flex bg-gradient-to-b from-[#F5F5F0] to-[#EEEEE8] p-2 rounded-full border border-zinc-200/50 shadow-inner">
                <button
                  ...
                  className={`px-8 py-3 rounded-full text-sm font-bold transition-all flex items-center gap-2 duration-500 ${activeTab === "work" ? "bg-gradient-to-r from-[#121110] to-[#2a2a2a] text-white shadow-[0_8px_30px_-10px_rgba(0,0,0,0.5)] scale-105" : "text-zinc-500 hover:text-zinc-800 hover:bg-white/50"}`}
                >
                  <IconBriefcase className="w-4 h-4" /> Company Workspace
                </button>
                <button
                  onClick={() => setActiveTab("personal")}
                  className={`px-8 py-3 rounded-full text-sm font-bold transition-all flex items-center gap-2 duration-500 ${activeTab === "personal" ? "bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] text-white shadow-[0_8px_30px_-10px_rgba(255,138,101,0.6)] scale-105" : "text-zinc-500 hover:text-zinc-800 hover:bg-white/50"}`}
                >
            ...
            <div className="flex justify-center relative z-10">
              <div className="w-[340px] h-[600px] bg-gradient-to-b from-zinc-50 to-white rounded-[3rem] border-[8px] border-zinc-800 shadow-[0_30px_90px_-20px_rgba(0,0,0,0.5)] overflow-hidden relative">
                ...
                {/* Header */}
                <div
                  className={`h-32 p-6 flex flex-col justify-end transition-all duration-700 ${activeTab === "work" ? "bg-gradient-to-br from-[#121110] to-[#2a2a2a]" : "bg-gradient-to-br from-[#FFF0E0] to-[#FFE4CC]"}`}
                >
                ...
                <div className="p-4 space-y-3 bg-gradient-to-b from-zinc-50 to-white">
                  {activeTab === "work" ? (
                    <>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-gradient-to-br from-blue-50 to-blue-100 rounded-full flex items-center justify-center text-lg shadow-sm border border-blue-200">
                            <Plane className="w-6 h-6" />
                          </div>
                          <div>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-gradient-to-br from-zinc-50 to-zinc-100 rounded-full flex items-center justify-center text-lg shadow-sm border border-zinc-200">
                    ...
                    <>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-gradient-to-br from-[#FFF0E0] to-[#FFE4CC] rounded-full flex items-center justify-center text-lg shadow-inner">
                      ...
                      <div className="mt-8 text-center px-6">
                        <p className="text-xs text-zinc-500 font-medium bg-gradient-to-br from-zinc-50 to-white p-3 rounded-xl border border-zinc-200 shadow-inner">
      ...
      <div id="solutions" className="space-y-12 px-6 py-24 max-w-7xl mx-auto">
        ...
        <section className="bg-white rounded-[3rem] p-8 md:p-16 border border-zinc-200/50 overflow-hidden relative shadow-[0_20px_70px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_25px_80px_-15px_rgba(0,0,0,0.15)] transition-shadow duration-500">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              <div className="w-14 h-14 bg-gradient-to-br from-[#FF8A65] to-[#FF6B45] rounded-2xl flex items-center justify-center text-white mb-8 shadow-lg shadow-orange-200 rotate-2 hover:rotate-0 hover:scale-110 transition-all duration-300">
            ...
            <div className="relative h-[400px] flex items-center justify-center">
              <div className="relative w-full max-w-md">
                ...
                {/* Extracted Data Card */}
                <div className="absolute top-1/2 right-0 -translate-y-1/2 w-56 bg-gradient-to-br from-[#121110] to-[#2a2a2a] text-white rounded-2xl shadow-2xl rotate-[3deg] p-5 z-30 hover:rotate-[1deg] hover:scale-105 transition-all duration-300">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#FF8A65] to-[#FF6B45] flex items-center justify-center text-white shadow-lg shadow-orange-500/30">
        ...
        {/* 2. MANAGER SECTION */}
        <section className="bg-gradient-to-br from-[#121110] to-[#1f1f1f] text-white rounded-[3rem] p-8 md:p-16 border border-zinc-800 overflow-hidden relative shadow-[0_30px_90px_-20px_rgba(0,0,0,0.5)]">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div className="order-2 md:order-1 flex justify-center">
              <div className="w-[300px] bg-gradient-to-br from-[#1C1C1C] to-[#252525] rounded-3xl p-6 border border-white/10 shadow-2xl relative z-10 transform -rotate-1 hover:rotate-0 hover:scale-105 transition-all duration-500">
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-white/5 border border-white/5 rounded-xl flex justify-between items-center hover:bg-white/10 transition-all duration-300 hover:scale-[1.02]">
                    <div className="flex gap-3">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#D0FC42] to-[#b8e332] flex items-center justify-center text-xs font-bold text-black shadow-lg shadow-lime-500/20">
                        JS
                      </div>
                      <div>
                  ...
                  <div className="p-4 bg-white/5 border border-white/5 rounded-xl flex justify-between items-center hover:bg-white/10 transition-all duration-300 hover:scale-[1.02]">
                    <div className="flex gap-3">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-xs font-bold text-black shadow-lg shadow-blue-500/20">
                        AL
                      </div>
                      <div>
                ...
                <button className="w-full mt-6 bg-gradient-to-r from-[#D0FC42] to-[#b8e332] text-black font-bold py-3 rounded-xl text-xs hover:scale-105 transition-all duration-300 shadow-lg shadow-lime-500/20 hover:shadow-lime-500/40">
                  Confirm Approvals (2)
                </button>
              </div>
            </div>
        ...
        {/* 3. FINANCE SECTION */}
        <section className="bg-white rounded-[3rem] p-8 md:p-16 border border-zinc-200/50 overflow-hidden relative shadow-[0_20px_70px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_25px_80px_-15px_rgba(0,0,0,0.15)] transition-shadow duration-500">
          <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-[#D0FC42]/5 to-transparent blur-3xl pointer-events-none"></div>

          <div className="grid md:grid-cols-2 gap-16 items-center relative z-10">
            <div>
              <div className="w-14 h-14 bg-gradient-to-br from-[#D0FC42] to-[#b8e332] rounded-2xl flex items-center justify-center text-[#121110] mb-8 shadow-lg shadow-lime-200 -rotate-2 hover:rotate-0 hover:scale-110 transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-[#F7F5F2] to-[#EEEEE8] rounded-[2.5rem] p-6 border border-zinc-200 shadow-xl hover:shadow-2xl transition-shadow duration-500">
              <div className="bg-white rounded-xl border border-zinc-200 overflow-hidden shadow-lg">
                <div className="flex items-center justify-between p-4 border-b border-zinc-100 bg-gradient-to-b from-zinc-50 to-white">
                  ...
                  <button className="flex items-center gap-2 text-[10px] font-bold bg-gradient-to-r from-[#121110] to-[#2a2a2a] text-white px-3 py-1.5 rounded-lg hover:scale-105 transition-all duration-300 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center gap-3 bg-white border border-zinc-200 rounded-full p-1.5 shadow-sm">
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-bold transition-all duration-300 ${
                  billingCycle === "monthly"
                    ? "bg-gradient-to-r from-[#121110] to-[#2a2a2a] text-white shadow-lg"
              ...
              >
                Annual
                <span className="absolute -top-2 -right-2 bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] text-white text-[9px] font-bold px-2 py-0.5 rounded-full">
                  Save 20%
                </span>
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            {/* Team Plan */}
            <div className="bg-gradient-to-br from-[#121110] to-[#2a2a2a] text-white rounded-[2rem] p-8 border-2 border-[#FF8A65] shadow-[0_20px_60px_-15px_rgba(255,138,101,0.4)] hover:shadow-[0_25px_70px_-15px_rgba(255,138,101,0.5)] transition-all duration-300 hover:-translate-y-1 relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] text-white text-xs font-bold px-4 py-1 rounded-full shadow-lg">
                MOST POPULAR
              </div>
              <div className="mb-6">
              ...
              <button className="w-full bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] text-white py-3 rounded-full font-bold hover:scale-105 transition-transform shadow-lg mb-6">
                Start Free Trial
              </button>
              <ul className="space-y-3">
                <li className="flex gap-3 items-start text-sm">
      ...
      <section id="faq" className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-12 text-center bg-gradient-to-br from-[#FFF0E0] to-[#FFE4CC] rounded-2xl p-8 border border-orange-200">
            <h3 className="text-xl font-bold mb-2">Still have questions?</h3>
            <p className="text-zinc-600 mb-6">
              Our team is here to help you get started with FlowState
            </p>
            <button className="px-6 py-3 bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] text-white rounded-full font-bold hover:scale-105 transition-transform shadow-lg">
              Contact Support
            </button>
          </div>
        </div>
      ...
      {/* FOOTER - REDESIGNED */}
      <footer className="bg-gradient-to-br from-[#121110] to-[#1f1f1f] text-white pt-24 pb-0 rounded-t-[3rem] relative overflow-hidden">
        {/* Ambient glow */}
        ...
        <div className="max-w-4xl mx-auto text-center px-6 mb-24 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="px-8 py-4 bg-gradient-to-r from-[#FF8A65] to-[#FF6B45] text-white rounded-full text-lg font-bold hover:scale-105 transition-all duration-300 shadow-[0_0_40px_-10px_rgba(255,138,101,0.6)] hover:shadow-[0_0_50px_-10px_rgba(255,138,101,0.8)]">
              Start Your Vault
            </button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            <div className="col-span-2 md:col-span-1 space-y-4">
              <div className="flex items-center gap-2 font-bold text-xl">
                <div className="w-4 h-4 bg-gradient-to-br from-[#FF8A65] to-[#FF6B45] rounded-full shadow-lg shadow-orange-500/30" />
                FlowState
              </div>
